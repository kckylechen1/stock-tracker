        ...
        <div className="flex-1 flex flex-col overflow-hidden">
            ...
            <div className="flex border-b border-border bg-card/30">
                <button
                    ...
                    className={`flex-1 px-4 py-2.5 text-sm font-medium transition-colors relative ${activeTab === 'sentiment'
                            ? 'text-foreground'
                ...
                <button
                    ...
                    className={`flex-1 px-4 py-2.5 text-sm font-medium transition-colors relative ${activeTab === 'technical'
                            ? 'text-foreground'
                            : 'text-muted-foreground hover:text-foreground'
                        }`}
                >
                                    ...
                                    <div className="flex items-center justify-between mb-2">
                                        ...
                                        <div className="flex items-baseline gap-1.5">
                                            ...
                                            <span
                                                ...
                                                style={{
                                                    color: getFearGreedColor(safeValue(fearGreedIndex, 'value', 50)),
                                            ...
                                            style={{
                                                color: safeValue(marketTemperature, 'level') === 'hot' || safeValue(marketTemperature, 'level') === 'warm'
                                                    ...
                                                    : safeValue(marketTemperature, 'level') === 'cold' || safeValue(marketTemperature, 'level') === 'cool'
                                                        ? '#3b82f6'
                                                        : '#f59e0b',
                                                backgroundColor: safeValue(marketTemperature, 'level') === 'hot' || safeValue(marketTemperature, 'level') === 'warm'
                                                    ? '#ef444415'
                                                    : safeValue(marketTemperature, 'level') === 'cold' || safeValue(marketTemperature, 'level') === 'cool'
                                                        ? '#3b82f615'
                                                        : '#f59e0b15'
                                ...
                                <div className="p-3 rounded-xl bg-gradient-to-br from-card/80 to-card/40 border border-border/40 hover:border-border/60 transition-all duration-200">
                                    ...
                                    <div className="flex h-2 rounded-full overflow-hidden mb-2.5 shadow-inner bg-muted/30">
                                        ...
                                        <div
                                            ...
                                            style={{ flex: 100 - safeValue(marketBreadth, 'riseRatio', 50) }}
                                        />
                                    </div>
                                    <div className="flex justify-between text-xs">
                                        <span className="text-[#ef4444]/80 font-medium">涨停 {safeValue(marketBreadth, 'limitUpCount', 0)}</span>
                                        <span className="text-[#22c55e]/80 font-medium">跌停 {safeValue(marketBreadth, 'limitDownCount', 0)}</span>
                                    </div>
                                </div>
                            </>
                        ) : (
