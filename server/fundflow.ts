...
export async function getStockFundFlow(code: string) {
    try {
        ...
        const response = await axios.get('https://push2.eastmoney.com/api/qt/stock/fflow/kline/get', {
            params: {
                secid,
                fields1: 'f1,f2,f3,f7',
 ...
 * @param limit 数量
 */
export async function getFundFlowRank(type: 'today' | '3day' | '5day' | '10day' = 'today', limit: number = 50) {
    try {
