...
export function searchEndpoints(keyword: string): AKShareEndpoint[] {
    ...
    return AKSHARE_CATALOG.filter(ep => 
...
export const AKSHARE_TOOL_DEFINITIONS = [
    {
        ...
        function: {
            ...
            description: "检查 AKTools 服务是否可用。在调用任何 AKShare 接口前应先检查状态。",
            parameters: {
                type: "object",
                properties: {},
            },
...
- stock_zt_pool_em: 涨停股票池`,
    ...
    },
    {
        ...
        function: {
            ...
            description: "搜索可用的 AKShare 接口。当不确定应该使用哪个接口时，可以先搜索。",
            parameters: {
                type: "object",
                properties: {
                    keyword: {
    ...
    },
    {
        ...
        function: {
            ...
            description: "获取指定 AKShare 接口的详细信息，包括参数说明和返回值说明。",
            parameters: {
                type: "object",
                properties: {
                    endpoint: {
    ...
    switch (toolName) {
        ...
        case 'search_akshare_endpoint': {
            ...
            return JSON.stringify(endpoints.map(ep => ({
                ...
                parameters: ep.parameters.map(p => `${p.name} (${p.required ? '必填' : '可选'})`),
            })), null, 2);
        }
        ...
        case 'get_akshare_endpoint_info': {
            ...
            return JSON.stringify({
                ...
                example_call: info.parameters.length > 0
